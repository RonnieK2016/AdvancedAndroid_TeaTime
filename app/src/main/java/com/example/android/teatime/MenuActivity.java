...
// COMPLETED Implement ImageDownloader.DelayerCallback
public class MenuActivity extends AppCompatActivity implements ImageDownloader.DelayerCallback {
    ...
    // COMPLETED Add a SimpleIdlingResource variable that will be null in production
    @Nullable
    SimpleIdlingResource simpleIdlingResource;

    /**
     * COMPLETED Create a method that returns the IdlingResource variable. It will
    ...
    /**
     * COMPLETED Using the method you created, get the IdlingResource variable.
    ...
    // COMPLETED Override onDone so when the thread in ImageDownloader is finished, it returns an
